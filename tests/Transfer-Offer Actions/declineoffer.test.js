...
describe('test declineoffer contract', () => {
    let blockchain;
    let atomicassets;
    let user1;
    let user2;
    ...
    test("decline offer", async () => {
        ...
        await atomicassets.actions.declineoffer([
            1
    ...
    test("throw without authorization from the offer recipient", async () => {
        ...
        await expect(atomicassets.actions.declineoffer([
            1
